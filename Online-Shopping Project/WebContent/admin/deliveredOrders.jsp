...
<table id="customers">
       ...
       try{
    	   Connection con=ConnectionProvider.getCon();
   		   ...
   		   ResultSet res=stmt.executeQuery("select *from cart inner join product where cart.product_id=product.id and cart.orderDate is not NULL and cart.status='Delivered'");
   		   while(res.next())
   		   {
       %> 
